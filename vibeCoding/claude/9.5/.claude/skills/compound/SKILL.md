...
| `~/.claude/lessons/INDEX.md` (全局) | 主题索引 | /lesson-curator | 主题命中 |
| `~/.claude/lessons/{date}-{slug}.md` (全局) | 已确认工具链经验 | 用户落档 | 索引命中后 Read |
| `~/.claude/lessons/draft-*.md` (全局) | 自动起草 | lesson-drafter hook | 不读, 待审 |
