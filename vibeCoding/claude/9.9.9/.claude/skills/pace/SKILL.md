...
恢复与证据：[state-contract.md](references/state-contract.md)；派发/接收/整合：[execution-contracts.md](references/execution-contracts.md)；全栈准入：[fullstack-contract.md](references/fullstack-contract.md)；CC 原生与配置：[platform-contracts.md](references/platform-contracts.md)。
