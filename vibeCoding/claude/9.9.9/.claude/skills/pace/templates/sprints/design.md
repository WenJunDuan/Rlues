...
> 机器契约: AC 可观测, 禁占位; 不交叉引用 AC 编号; 本段唯一验收; 证据给出处; 门禁规则不写进本模板。
...
[有 writer/交接时引用基线、允许写集、绝对 worktree 与唯一整合者；恢复按 pace/references/execution-contracts.md。真实全栈切片开始前按 fullstack-contract.md 记录项目准入与四类业务断言。]
