...
This skill is the frontend/E2E test arm of `athena-runtime-verify`. It complements the enabled `playwright-skill@anthropic-official` plugin and gives Athena-specific evidence rules.
