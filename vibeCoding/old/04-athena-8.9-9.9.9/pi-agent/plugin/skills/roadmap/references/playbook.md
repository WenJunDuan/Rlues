...
cp ~/.pi/agent/skills/pace/templates/roadmap/roadmap.md .ai_state/roadmap/$slug/
cp ~/.pi/agent/skills/pace/templates/roadmap/items.yaml .ai_state/roadmap/$slug/
```

### Step 2: 调用 architect 调研

主 agent 用 CC 当前 subagent 工具启动 read-only architect:
- 探索代码库
