...
console.log("\n=== Skills ===");
const skills = ["brainstorm","cunzhi","tdd","verification","code-quality",
  "knowledge","agent-teams","context7","plan-first","smart-archive",
  "e2e-testing","security-review","quickstart"];
