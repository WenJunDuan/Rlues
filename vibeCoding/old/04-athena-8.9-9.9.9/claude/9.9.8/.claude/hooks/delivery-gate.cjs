...
function validateReviewPacket(sprintDir) {
  ...
  if (fs.existsSync(designPath)) {
    const designIds = extractAcIds(fs.readFileSync(designPath, "utf8"));
...
if (require.main === module) {
  ...
  module.exports = { sourceDiffSha256, fileSha256, extractAcIds, parseDocFrontmatter, validateReviewPacket, GateError };
}
