...
3. 黄区: Task tool 调用 `generator` subagent (TDD: 测试先, 代码后); **v9.9.0 (U1)**: Feature+ 的 impl 必须留下 generator 痕迹 (subagent-log.md), delivery-gate 在 ship 机械验 — 主 agent 全程亲手写 = block
