...
# PACE — Router & State Machine (v9.8.0, Codex)
...
- runtime-verify (Refactor/System 强制 · Feature 可选): /athena-runtime-verify 用 Codex Goals 实跑 + 自测自改, 产出 runtime-verify.md (delivery-gate 验)
