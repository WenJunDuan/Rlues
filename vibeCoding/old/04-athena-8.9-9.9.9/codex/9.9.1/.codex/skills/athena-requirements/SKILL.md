...
description: |
  维护 .ai_state/requirements/ 长效需求档 (软件要素: 为什么要这个能力), Codex.
...
`design.md` frontmatter 加 `req_ref: requirements/{slug}.md`. 这样 review 的 spec-compliance 不只对 design, 还能回溯**原始需求**, 抓"实现偏离了最初意图"这一层。
