...
# v9.6.4 schema. 项目执行 athena-init 时由模板初始化, 之后由主 agent + hooks 维护.
version: "9.7.0"

# === PACE 路由状态 ===
path: ""                          # Hotfix | Bugfix | Quick | Feature | Refactor | System
stage: ""                         # brainstorm | roadmap | plan | design | impl | review | polish | ship
...
# === PACE 联动字段 (v9.6.4 新, hook 自动维护) ===
next_action: ""                   # evaluator/Stop prompt 写: polish | ship | rework_impl | next_roadmap_item:{slug}
