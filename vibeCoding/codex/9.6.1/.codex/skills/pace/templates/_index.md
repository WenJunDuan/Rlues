...
platform_features:
  ...
  cx_version: ""                # 同上
  goal_supported: false         # CC ≥ v2.1.139 或 Codex ≥ v0.128.0 时 true (v9.6.1 对齐)
  batch_supported: false        # CC ≥ v2.1.121 时 true (Codex 无原生 /batch)
  background_supported: false   # CC ≥ v2.1.139 时 true (Codex 无)
