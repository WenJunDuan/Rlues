...
cp ~/.pi/agent/skills/pace/templates/sprints/brainstorm.md .ai_state/sprints/$slug/
```
...
见 `~/.pi/agent/skills/pace/templates/sprints/brainstorm.md` (v9.9.6 distilled-log 格式)
