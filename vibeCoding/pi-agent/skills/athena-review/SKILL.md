...
稳定审查提示在本 skill 的 [REVIEW.md](REVIEW.md)（Claude Code skill 支持文件，不是 `~/.pi/agent/skills/athena-review/REVIEW.md`）。sprint 合同用 `review-packet.md`。
...
- 把 `~/.pi/agent/skills/athena-review/REVIEW.md` 当 skill 入口
