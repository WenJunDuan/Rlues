...
stage: "plan"                  # roadmap 已拆分；当前 item 只读评估并形成可审设计
...
# === Pointers (指向最新相关文件) ===
pointers:
  latest_design: "sprints/2026-07-28-installation-sync-w31-w34/design.md"
...
next_action: "plan: 汇总双端热路径、Hook 税、状态与契约证据，形成 hotfix2 设计；等待 Fable5 review 后再进入 impl"
