...
stage: ""                       # 2026-07-28 用户主动关闭该方向；不再有活动 sprint
current_sprint_slug: ""
...
next_action: "closed_by_user: 2026-07-28 用户决定停止 9.9.6 prompt-engineering / gate-descaling 方向；不再推进或考虑同类扩展。历史档案、已完成工作和本地 draft 安装记录保留；如需新方向另立 sprint。"
