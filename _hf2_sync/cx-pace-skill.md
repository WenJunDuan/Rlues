...
# PACE — Router & State Machine (v9.9.6, Codex)
...
- plan/design: `plan_mode_reasoning_effort = xhigh` 已生效; critic 多轮 (max = `_index.plan_critique_max_rounds`); `_index.plan_model: opus` 为 CC 端专属 (Opus 5), CX 端使用 xhigh reasoning effort
